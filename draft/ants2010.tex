...
\centering
\includegraphics[height=5cm, angle=0]{../dia-files/AFM-Diag2.eps}
...
\label{eqn:sigle-pmw}
\end{equation}
For a shop-floor with M machines, we can find the average PMW per machine per time-step, $\chi_{avg}^{MOM}$, by following this equation.
