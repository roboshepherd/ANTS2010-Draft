...
\caption{\small Sum of robot translations  in centralized  mode }
...
%figure caption is below the figure
\caption{\small Convergence of task urgencies in  $r_{comm}$=0.5m}
...
%figure caption is below the figure
\caption{\small Sum of translations of all robots in  $r_{comm}$=0.5m }
...
\begin{minipage}[t]{0.5\linewidth}
\centering
\includegraphics[height=5cm,width=3in]{images/local-1m/TaskUrgencyConvergence}
\caption{\small Convergence of task urgencies in  $r_{comm}$=1m}
...
\caption{\small Sum of translations of all robots in  $r_{comm}$=1m }
...
%figure caption is below the figure
\caption{\small Changes in sensitizations  in  $r_{comm}$=0.5m}
...
\caption{\small Changes in sensitizations  in  $r_{comm}$=1m}
...
\caption{\small Peer signals caught by Robot12 in  $r_{comm}$=0.5m}
...
\caption{\small Peer signals caught by Robot12 in  $r_{comm}$=1m}
...
\caption{\small  P2P signalling Frequency in  $r_{comm}$=0.5m}
...
\caption{\small P2P signalling Frequency in e $r_{comm}$=1m}
